...
table1 <- fread('C:/Users/ngraetz/Desktop/may22_tables/table1.csv')
...
landscape(kable(table1[,c(1,2:15)], align=rep('r',15), format = 'latex', booktabs = TRUE, longtable=T, caption = '', digits = 1,
                escape=F) %>%
   kable_styling(font_size = 7) %>%
   add_header_above(c(" " = 1, 'ASCDR' = 2,
                      'Black' = 2, 'Hispanic' = 2, 'Ages\n25-64' = 2, 'Foreign-\nborn' = 2,
                      'College' = 2, 'Poverty' = 2)) %>%
...
landscape(kable(table1[,c(1,16:29)], align=rep('r',15), format = 'latex', booktabs = TRUE, longtable=T, caption = '', digits = 1,
                escape=F) %>%
   kable_styling(font_size = 7) %>%
   add_header_above(c(" " = 1, 'Transfers' = 2, 'Manuf' = 2,
                      'MDs' = 2, 'Mammo' = 2, 'Diab' = 2,
                      'Obesity' = 2, 'Smoking' = 2)) %>%
   group_rows("Large metro", 1, 10) %>%
   group_rows("Fringe metro", 11, 20) %>%
   group_rows("Small metro", 21, 30) %>%
